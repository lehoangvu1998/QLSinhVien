...
(
	...
	QUANHE NVARCHAR (15),
	MAUSERS INT PRIMARY KEY,
	FOREIGN KEY (MAUSERS) REFERENCES  USERS (MAUSERS) ON DELETE CASCADE
...
delete from USERS where MAUSERS = 21995662
...
SELECT us.MAUSERS, us.HOTEN, us.SDT, us.NGAYSINH, us.EMAIL, us.DIACHI, us.PASS, us.HOCVAN, us.NGAYVAOTRUONG, kh.TENKHOA, tn.TENTHANNHAN, tn.SDTTHANNHAN, tn.QUANHE FROM USERS us, KHOA kh, THANNHAN tn WHERE tn.MAUSERS = us.MAUSERS and us.ROLE = 1